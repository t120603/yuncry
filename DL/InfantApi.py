...
cid = '7018883e11b96b5b265b092f16daf5ea'
...
class InfantWebAPI:
    def __init__(self,domain_url):
        ...
        self._addmember_url = self._domain_url + "addmember.php"

    def recognize(self,user_account,filepath):
        files = {'file': open(filepath, 'rb')}
        values = {'cid':cid,'dirname': user_account}
        datas = {'cid':cid,'dirname': user_account,'file': open(filepath, 'rb'),}
    ...
    def informationIOS(self,user_account,sex='male',date='2018-01-13',country='TW'):
        values = {'cid':cid,'country':country,"dirname":user_account,'sex':sex,'date':date,"id":user_account}
        res = requests.post(self._informationIOS_url,data=values)
        return res,self._informationIOS_url
    def addmember(self,name='Test',email='mipl_test@gamil.com'):
        values = {'cid':cid,'name':name,"email":email}
        res = requests.post(self._addmember_url,data=values)
    ...
    def babyinformation(self,user_account,sex='male',date='2018-01-13',country='TW'):
        ...
        return res,self._addmember_url

    def datecheck(self,user_account):
        values = {'cid':cid,'dirname': user_account}
